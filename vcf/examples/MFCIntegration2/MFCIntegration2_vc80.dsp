...
# ADD CPP /nologo /MD /W3 /GR /GX /O1 /I "$(VCF_ROOT)/src" /I "./" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "USE_GRAPHICSKIT_DLL" /YX"stdafx.h" /FD /c
...
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"Release\MFCIntegration2_vc80.exe" /libpath:"$(VCF_ROOT)/lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_ROOT)/src" /I "./" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "USE_GRAPHICSKIT_DLL" /YX"stdafx.h" /FD /GZ /c
...
# ADD LINK32 rpcrt4.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug\MFCIntegration2_vc80.exe" /pdbtype:sept /libpath:"$(VCF_ROOT)/lib"
