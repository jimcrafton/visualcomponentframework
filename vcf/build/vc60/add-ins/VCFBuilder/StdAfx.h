...
#if !defined(AFX_STDAFX_H__00CD78A4_68EA_427D_A89E_271068B90A13__INCLUDED_)
#define AFX_STDAFX_H__00CD78A4_68EA_427D_A89E_271068B90A13__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in VCFBuilder.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
