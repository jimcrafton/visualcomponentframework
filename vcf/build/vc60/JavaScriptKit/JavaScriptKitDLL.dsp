...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"..\..\..\bin\JavaScriptKit_vc6.dll" /implib:"..\..\..\lib\JavaScriptKit_vc6.lib" /libpath:"$(VCF_ROOT)/lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_ROOT)/src" /I "./" /I "$(VCF_ROOT)/src/JavaScriptKit/js-impl" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "USE_FOUNDATIONKIT_DLL" /D "JAVASCRIPTKIT_DLL" /D "JAVASCRIPTKIT_EXPORTS" /D "EXPORT_JS_API" /D "XP_WIN" /YX /Fd"..\..\..\bin\JavaScriptKit_vc6_d.pdb" /FD /GZ /c
