...
// VCFAppWizard
	...
	var strDestFolder = FileSys.BuildPath( strValue, "\\vcprojects\\VisualComponentFramework" );
	if(bDebug)
...
// VCFLibraryAppWizard
	...
	var strDestFolder = strValue + "\\vcprojects\\VisualComponentFramework";
	if(bDebug)
		WScript.Echo("Destination: " + strDestFolder);
	if(!FileSys.FolderExists(strDestFolder))
	{
...
*/
	...
	WScript.Echo("The VCF Application Wizards have been successfully installed!");
}
