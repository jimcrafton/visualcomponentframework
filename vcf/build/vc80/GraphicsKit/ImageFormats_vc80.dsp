...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_ROOT)/src" /I "$(VCF_ROOT)/src/../thirdparty/common/paintlib/common" /I "$(VCF_ROOT)/src/../thirdparty/common/agg/include/" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "NO_MFC" /D "IMAGEFORMATS_DLL" /D "IMAGEFORMATS_EXPORTS" /D "USE_PAINTLIB_LIB" /D "USE_APPLICATIONKIT_DLL" /Fd"..\..\..\bin\ImageFormats_vc80_d.pdb" /FD /GZ /c
