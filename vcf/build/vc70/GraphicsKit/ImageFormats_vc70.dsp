...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_INCLUDE)" /I "../../../thirdparty/common/FreeImage/Source" /I "$(VCF_INCLUDE)/../thirdparty/common/agg/include/" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "NO_MFC" /D "IMAGEFORMATS_DLL" /D "IMAGEFORMATS_EXPORTS" /D "FREEIMAGE_LIB" /D "USE_FREEIMAGE_LIB" /D "USE_APPLICATIONKIT_DLL" /Fd"..\..\..\bin\ImageFormats_vc70_d.pdb" /FD /GZ /c
