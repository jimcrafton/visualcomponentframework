...
#if !defined(AFX_COMMANDS_H__DBFA0856_1D70_460D_AB15_CB5436CA26F1__INCLUDED_)
#define AFX_COMMANDS_H__DBFA0856_1D70_460D_AB15_CB5436CA26F1__INCLUDED_

#include "VCFBuilderTypes.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_VCFBuilder>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_VCFBuilder, 
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_VCFBuilder, 
...
public:
	...
	STDMETHOD(SaveProject)();
	STDMETHOD(NewProject)();
	STDMETHOD(OpenProject)();
// ICommands methods
	STDMETHOD(ActivateVCFBuilderEnvironment)(THIS);
};
