...
#ifndef AGG_SPAN_BGRA32_INCLUDED
#define AGG_SPAN_BGRA32_INCLUDED
...
namespace agg
{
    ...
    //========================================================================
    template<class BaseRenderer> class span_bgra32 : public BaseRenderer
    {
    public:
                    ...
                    const typename BaseRenderer::attr_type& attr)
        {
            ...
            register unsigned char* p = ptr + (x << 2);
            do
            {
                span.calculate();
