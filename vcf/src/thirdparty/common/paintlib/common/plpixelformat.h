...
/* These int64 defines added by vortic to fix compile error on MS Visual Studio 6 */
#ifndef PL_INT64
#if defined(_MSC_VER) || defined(__BORLANDC__)
#define PL_INT64 signed __int64
#else
#define PL_INT64 signed long long
#endif
#endif

#ifndef PL_INT64U
#if defined(_MSC_VER) || defined(__BORLANDC__)
#define PL_INT64U unsigned __int64
#else
#define PL_INT64U unsigned long long
#endif
#endif
