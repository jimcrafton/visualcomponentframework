...
//			}
	...
	public:
		...
		{
			::IUnknown *ret = COMET_STRICT_TYPENAME impl::coclass_table_entry<COMET_STRICT_TYPENAME CLS_LIST::head, FACTORY_SHOULD_LOCK_MODULE>::factory::get(clsid);
		...
		{
			COMET_STRICT_TYPENAME impl::coclass_table_entry<COMET_STRICT_TYPENAME CLS_LIST::head, FACTORY_SHOULD_LOCK_MODULE>::registration::perform(filename, unregister, inproc_server, appid);
