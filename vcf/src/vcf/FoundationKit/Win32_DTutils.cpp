...
DoTime:
	...
	dtDest.set( tmDest.tm_year, tmDest.tm_mon, tmDest.tm_mday, 
...
bool OleDateFromDateTime( const VCF::DateTime& srcDt, DATE& dtDest)
{
	...
	wYear = (WORD)srcDt.getYear();
	wMonth = (WORD)srcDt.getMonth();
	wDay = (WORD)srcDt.getDay();
	wHour = (WORD)srcDt.getHour();
	wMinute = (WORD)srcDt.getMinute();
	wSecond = (WORD)srcDt.getSecond();
