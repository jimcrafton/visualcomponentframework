...
void ProcessWithRedirectedIO::addOutputReadyHandler( EventHandler* eventHandler )
{
	processPeer_->addOutputReadyHandler( eventHandler );
}

void ProcessWithRedirectedIO::removeOutputReadyHandler( EventHandler* eventHandler )
{
	processPeer_->removeOutputReadyHandler( eventHandler );
}
