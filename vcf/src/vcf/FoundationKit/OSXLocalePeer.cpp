...
DateTime OSXLocalePeer::toDateTime( const UnicodeString& str, const String& format )
{
    throw NotImplementedException();
}

UnicodeString OSXLocalePeer::getAMSymbol()
{
    throw NotImplementedException();
}

UnicodeString OSXLocalePeer::getPMSymbol()
{
    throw NotImplementedException();
}
