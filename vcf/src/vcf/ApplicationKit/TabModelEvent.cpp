...
TabModelEvent::TabModelEvent( Object * source, TabPage* page ):
	Event( source )
{
	page_ = page;
}

TabModelEvent::TabModelEvent( Object* source, const unsigned long& eventType, TabPage* page ):
	Event( source, eventType )
{
	page_ = page;
}

TabModelEvent::~TabModelEvent()
{

}

TabPage* TabModelEvent::getTabPage()
{
	return page_;
}
