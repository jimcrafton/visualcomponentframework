...
TreeModelEvent::TreeModelEvent( Object* source, const ulong32& type ):
	Event( source, type )
{

}

TreeModelEvent::TreeModelEvent( Object* source, TreeItem* item, const ulong32& type ):
	Event( source, type )
{
	this->item_ = item;
}
...
TreeItem* TreeModelEvent::getTreeItem()
{
	return item_;
}

void TreeModelEvent::setTreeItem( TreeItem* item )
{
	item_ = item;
}
...
*
*Revision 1.7  2002/03/01 01:02:53  ddiego
