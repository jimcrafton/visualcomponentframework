#ifndef _VCF_COMMONCOLOR_H__
#define _VCF_COMMONCOLOR_H__
//CommonColor.h
...
class APPLICATIONKIT_API CommonColor : public CommonDialog {
public:

	CommonColor( Control* owner = NULL );
