#ifndef _VCF_COMMONFONT_H__
#define _VCF_COMMONFONT_H__
//CommonFont.h
...
class APPLICATIONKIT_API CommonFont : public CommonDialog{
public:
	CommonFont( Control* owner );
