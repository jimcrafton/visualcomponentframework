...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "$(VCF_ROOT)/src" /I "./" /I "./DBProviders/sqlite" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "DATABASEKIT_LIB" /D "USE_FOUNDATIONKIT_LIB" /D "NO_TCL" /D "OS_WIN" /D "SQLITE_ENABLE_COLUMN_METADATA" /YX /FD /c
