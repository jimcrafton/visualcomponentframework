...
PLATFORM=VC-WIN32
CC=cl
CFLAG= /Od -DDEBUG -D_DEBUG /MDd /W3 /WX /GF /Gy /Zi /nologo -DOPENSSL_SYSNAME_WIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DBN_ASM -DMD5_ASM -DSHA1_ASM -DRMD160_ASM -DOPENSSL_USE_APPLINK -I. /Fdssleay32d.pdb -DOPENSSL_NO_CAMELLIA -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_KRB5 -DOPENSSL_NO_DYNAMIC_ENGINE    
APP_CFLAG=
LIB_CFLAG= -D_WINDLL
SHLIB_CFLAG=
...
MKLIB=lib
MLFLAGS= /debug /nologo /subsystem:console /opt:ref /debug /dll
...
$(O_SSL): $(SSLOBJ)
	$(LINK) $(MLFLAGS) /out:$(O_SSL) /def:ms/SSLEAY32D.def @<<
...
$(O_CRYPTO): $(CRYPTOOBJ)
	$(LINK) $(MLFLAGS) /out:$(O_CRYPTO) /def:ms/LIBEAY32D.def @<<
