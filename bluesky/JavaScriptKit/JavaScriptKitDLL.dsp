...
# ADD CPP /nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "JAVASCRIPTKITDLL_EXPORTS" /YX /FD /c
...
# PROP BASE Output_Dir "JavaScriptKitDLL___Win32_Debug"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"../../vcf/bin/JavaScriptKit_vc6_d.dll" /implib:"../../vcf/lib/JavaScriptKit_vc6_d.lib" /pdbtype:sept /libpath:"$(VCF_ROOT)/lib"
