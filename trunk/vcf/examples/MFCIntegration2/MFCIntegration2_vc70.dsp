...
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"Release\MFCIntegration2_vc70.exe" /libpath:"$(VCF_ROOT)/lib"
...
# ADD LINK32 rpcrt4.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug\MFCIntegration2_vc70.exe" /pdbtype:sept /libpath:"$(VCF_ROOT)/lib"
