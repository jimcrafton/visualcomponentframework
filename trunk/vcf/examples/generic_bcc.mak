...
CPPFLAGS=$(TFLAGS) $(CUSTOMCPP) -q -Q+ -6 -tWM -VF -RT -x -a8 -b -X- -w-aus -w-sig -w-voi -w-use -w-def -w-pin -w-8084 -w-inl -D$(SYSDEFINES);$(USERDEFINES)
CFLAGS=$(TFLAGS)  $(CUSTOMC) -q -6 -tWM -VF -w-aus -w-sus -w-pia -w-rch -w-ccc -w-eff -w-inl -D$(SYSDEFINES);$(USERDEFINES)
