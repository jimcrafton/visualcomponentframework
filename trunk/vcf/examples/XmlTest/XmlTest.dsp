...
!MESSAGE 
!MESSAGE "XmlTest - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "XmlTest - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "$(VCF_ROOT)/src" /I "$(VCF_ROOT)/src/thirdparty/common/libxml" /I "$(VCF_ROOT)/src/thirdparty/common/libxml/include" /I "$(VCF_ROOT)/src/thirdparty/common/libxslt" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_CONSOLE" /D "USE_FOUNDATIONKIT_DLL" /D "USE_XMLKIT_DLL" /FD /I$(VCF_ROOT)/src   /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_ROOT)/src" /I "$(VCF_ROOT)/src/thirdparty/common/libxml" /I "$(VCF_ROOT)/src/thirdparty/common/libxml/include" /I "$(VCF_ROOT)/src/thirdparty/common/libxslt" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_CONSOLE" /D "USE_FOUNDATIONKIT_DLL" /D "USE_XMLKIT_DLL" /FD /GZ /I$(VCF_ROOT)/src   /c
