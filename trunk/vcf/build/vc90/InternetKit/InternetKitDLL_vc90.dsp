...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"..\..\..\bin\InternetKit_vc90.dll" /libpath:"..\..\..\lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_ROOT)/src" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "USE_FOUNDATIONKIT_DLL" /D "INTERNETKIT_DLL" /D "INTERNETKIT_EXPORTS" /Fd"..\..\..\bin\InternetKit_vc90_d.pdb" /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib urlmon.lib /nologo /dll /debug /machine:I386 /out:"..\..\..\bin\InternetKit_vc90_d.dll" /pdbtype:sept /libpath:"..\..\..\lib"
