========================================================================
                    CUSTOM APPWIZARD: VCFFormWizard
========================================================================


AppWizard has created a VCFFormWizard DLL for you.  This DLL is the starting point
...
you build VCFFormWizard.awx, it will automatically be copied to your Template
...
make up your VCFFormWizard DLL.
...
VCFFormWizardAw.h, VCFFormWizardAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CVCFFormWizardAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into VCFFormWizard.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named VCFFormWizard.pch and a precompiled types file named StdAfx.obj.
