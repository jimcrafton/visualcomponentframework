...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(VCF_INCLUDE)" /I "$(VCF_INCLUDE)/thirdparty/win32" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "HTMLKIT_DLL" /D "HTMLKIT_EXPORTS" /D "USE_APPLICATIONKIT_DLL" /Fd"..\..\..\bin\HTMLKit_vc70_d.pdb" /Yu"vcf/HTMLKit/HTMLKit.h" /FD /GZ /c
