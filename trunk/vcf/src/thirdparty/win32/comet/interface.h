...
namespace comet {
	 ...
	 */
	template<typename ITF, UUID *ItfID, typename BASE = ::IUnknown> struct uuid_comtype
	{
	...
	/** Provid acces to uuid and base type of objects.
	  * Specialisations allow access to information relevent to non-comet
	  * defined interfaces.
	  */
