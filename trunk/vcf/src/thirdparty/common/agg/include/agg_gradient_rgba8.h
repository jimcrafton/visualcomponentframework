...
#ifndef AGG_GRADIENT_RGBA8_INCLUDED
#define AGG_GRADIENT_RGBA8_INCLUDED
...
namespace agg
{
    ...
    //========================================================================
    template<typename GradientF> class gradient_rgba8
    {
    public:
        typedef gradient_attr<rgba8, GradientF, unsigned char, 8> attr_type;
