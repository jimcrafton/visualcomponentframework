...
namespace agg
{
    ...
    inline bool     is_stop(unsigned c)     { return path_cmd(c) == path_cmd_stop;    }
    inline bool     is_move_to(unsigned c)  { return path_cmd(c) == path_cmd_move_to; }
    inline bool     is_end_poly(unsigned c) { return is_move_to(c) || is_stop(c); }
    inline bool     is_line_to(unsigned c)  { return path_cmd(c) == path_cmd_line_to; }
    inline bool     is_curve3(unsigned c)   { return path_cmd(c) == path_cmd_curve3;  }
    inline bool     is_curve4(unsigned c)   { return path_cmd(c) == path_cmd_curve4;  }
