...
#ifndef AGG_SPAN_GRADIENT_RGBA8_INCLUDED
#define AGG_SPAN_GRADIENT_RGBA8_INCLUDED
...
namespace agg
{
    ...
    //========================================================================
    template<class GradientF> class span_gradient_rgba8
    {
    public:
        typedef gradient_attr<rgba8, GradientF, int8u, 8> attr_type;
        ...
        public:
            ...
            void calculate()
            {
                ...
                m_rgba = m_gradient_array + m_profile[d];
            }
