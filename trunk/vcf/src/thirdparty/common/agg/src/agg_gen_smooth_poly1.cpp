...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    gen_smooth_poly1::gen_smooth_poly1() :
        m_src_vertices(),
        m_smooth_value(0.5),
        m_closed(0),
        m_status(initial),
    ...
    //------------------------------------------------------------------------
    void gen_smooth_poly1::remove_all()
    {
    ...
    //------------------------------------------------------------------------
    void gen_smooth_poly1::add_vertex(double x, double y, unsigned cmd)
    {
    ...
    //------------------------------------------------------------------------
    void gen_smooth_poly1::prepare_src()
    {
    ...
    //------------------------------------------------------------------------
    void gen_smooth_poly1::rewind(unsigned id)
    {
        m_status = initial;
        m_src_vertex = 0;
    }
    ...
    //------------------------------------------------------------------------
    void gen_smooth_poly1::calculate(const vertex_dist& v0, 
    ...
    //------------------------------------------------------------------------
    unsigned gen_smooth_poly1::vertex(double* x, double* y)
    {
                ...
                if(m_closed)
                {
                    if(m_src_vertex >= m_src_vertices.size())
                    {
                        ...
                        *y = m_src_vertices[0].y;
                        m_status = stop;
                        return path_cmd_curve4 | path_flags_close;
                    }
                }
                else
                {
                ...
                *y = m_src_vertices[m_src_vertex].y;
                ...
                if(m_closed)
                {
                    ...
                    return ((m_src_vertex == 1) ? 
                             path_cmd_move_to : 
                             path_cmd_curve4) | path_flags_close;
                }
                else
                {
                    if(m_src_vertex == 1)
