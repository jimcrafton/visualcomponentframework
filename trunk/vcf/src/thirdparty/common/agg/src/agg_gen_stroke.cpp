...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    void gen_stroke::miter_limit_theta(double t)
    { 
    ...
    //------------------------------------------------------------------------
    void gen_stroke::add_vertex(double x, double y, unsigned cmd)
    {
    ...
    //------------------------------------------------------------------------
    void gen_stroke::rewind(unsigned id)
    {
        m_status = initial;
        m_src_vertex = 0;
        m_out_vertex = 0;
    ...
    //------------------------------------------------------------------------
    unsigned gen_stroke::vertex(double* x, double* y)
    {
        ...
        while(!is_stop(cmd))
        {
            ...
            case out_vertices:
                ...
                else
                {
                    ...
                    *x = c.x;
                    *y = c.y;
                    return cmd | path_flags_close | path_flags_ccw;
                }
                break;
