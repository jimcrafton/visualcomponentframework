...
ListModelEvent::ListModelEvent( Object* source ):
	Event( source )
{

}

ListModelEvent::ListModelEvent( Object* source, const unsigned long& eventType ):
	Event( source, eventType )
{

}

ListModelEvent::ListModelEvent( Object* source, ListItem* item ):
	Event( source )
{
	this->listItem_ = item;
}

ListModelEvent::ListModelEvent( Object* source, const unsigned long& eventType, ListItem* item ):
	Event( source, eventType )
{
	this->listItem_ = item;
}

ListModelEvent::~ListModelEvent()
{

}

ListItem* ListModelEvent::getListItem()
{
	return this->listItem_;
}

void ListModelEvent::setListItem( ListItem* item )
{
	this->listItem_ = item;
}
...
*
*Revision 1.8.2.1  2003/03/12 03:11:56  ddiego
