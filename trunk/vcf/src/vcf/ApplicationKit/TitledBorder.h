...
*
*Revision 1.5.4.1  2004/04/26 21:58:40  marcelloptr
*changes for dir reorganization: _VCF_MACRO_H__
*
*Revision 1.5  2003/12/18 05:15:58  ddiego
*merge from devmain-0-6-2 branch into the stable branch
*
*Revision 1.4.4.3  2003/09/21 04:15:35  ddiego
*moved the cvs info data to teh bottom of the header instead of the
*top so it is easier to get to the actual header class declarations
*instead of having to wade through all the cvs info stuff.
*
*Revision 1.4.4.2  2003/09/12 16:46:33  ddiego
...
*
*Revision 1.3.2.2  2003/03/23 03:23:48  marcelloptr
*3 empty lines at the end of the files
*
*Revision 1.3.2.1  2003/03/12 03:10:48  ddiego
...
*
*Revision 1.2.2.1  2002/12/27 23:04:38  marcelloptr
...
*
*Revision 1.1.2.2  2002/10/18 03:06:35  ddiego
*changes to get the new form dialogs working
*
*Revision 1.1.2.1  2002/10/01 20:34:58  ddiego
*borders
*
*/
